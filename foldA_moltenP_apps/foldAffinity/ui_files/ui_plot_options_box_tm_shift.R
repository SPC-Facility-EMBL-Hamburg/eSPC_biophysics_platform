box(title = "Plot download options", width = 2, solidHeader = T, status = "primary", 
    fluidRow(
      ...
      conditionalPanel(condition = "input.show_plot_download_options_input_tmShift",
        ...
        column(6, p(HTML("<b>Width</b>"),
                    ...
                    tippy::tippy_this(elementId = "info_uu1-13_tmShift",
        ...
        column(6, p(HTML("<b>Height</b>"),
                    ...
                    tippy::tippy_this(elementId = "info_uu1-14_tmShift",
                                      tooltip = "Units are pixels * 50",placement = "right"))),
        ...
        column(6, p(HTML("<b>Axis text size</b>"),
                    numericInput('plot_axis_size_tmShift',NULL, 14,min = 4, max = 40))),
